...
const botName = "SuperBot";
const botLocation = "Vietnam";
...
let codingFact =
	"I like " + favoriteLanguage + " because it easy learn or not.";

console.log(codingFact);

codingFact = "Because I use " + favoriteLanguage + ", I also know TypeScript.";

console.log(codingFact);

codingFact = `I also update knowledge about version of ${favoriteLanguage}`;
